...
public class Student {
    ...
    public void calcAvarage() {
        this.avarage = calcSozlu() / 3;
    }

    public double calcSozlu(){
        double sozluSinav = (fizik.note * 0.8 + fizik.sozluNote * 0.20) + (kimya.note * 0.8 + kimya.sozluNote *0.2) + (mat.note * 0.8 + mat.sozluNote*0.2);
        return sozluSinav;
    }
