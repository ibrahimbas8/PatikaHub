    ...
    public OperatorGUI(Operator operator){
        ...
        mdl_user_list = new DefaultTableModel(){
            ...
            public boolean isCellEditable(int row, int column) {
                if (column == 0){
                    return false; //id tabloda değişmesin diye yaptık
                }
        ...
        tbl_patika_list.getTableHeader().setReorderingAllowed(false); //tabloda yer değiştirme aç kapa
        tbl_patika_list.getColumnModel().getColumn(0).setMaxWidth(75);//id alanı genişlik belirleme
