...
namespace Application.BookOperations.Commands.UpdateBook
{
    public class UpdateBookCommandValidatorTest : IClassFixture<CommonTestFixture>
    {
        ...
        /*[Theory]
        [InlineData(1,"Lor",1, 2)]
        [InlineData(0,"Lord",1, 0)]
        [InlineData(1,"Lord O",-1 ,1)]
        [InlineData(0,"Lor",0, 2)]
        [InlineData(-1,"Lord Of",-1, 3)]
        [InlineData(1," ",1, 0)]
        [InlineData(1,"",1, 1)]
        ...
        [Theory]
        [InlineData(1,1,"Lord Of The Rings",2)]
        public void WhenValidInputsAreGiven_Validator_ShouldNotBeReturnErrors(int bookid, int genreid, string title, int authorId)
        {
            UpdateBookCommand command = new UpdateBookCommand(null);
